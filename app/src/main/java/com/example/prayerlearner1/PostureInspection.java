...
public class PostureInspection extends AppCompatActivity  {
...
//        data.add(new String[]{"Axis", "TS","X", "Y", "Z", "TS","X", "Y", "Z","TS", "X", "Y", "Z"});
//
//
...
//    }
    ...
    public void taqbeer_check(View view) {
    startActivity(new Intent(this,PostureResult.class));
    }

    public void qiyam_check(View view) {
        startActivity(new Intent(this,PostureResult.class));
    }

    public void rakuh_check(View view) {
        startActivity(new Intent(this,PostureResult.class));
    }

    public void sadja_check(View view) {
        startActivity(new Intent(this,PostureResult.class));
    }
}
